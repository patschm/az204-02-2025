...
namespace WebSite
{
    ...
    {
        private string connectionString = "ps-radijs.redis.cache.windows.net:6380,password=BU6mp3UMtiJTIC1nk4wfNFs4WgTWoFcm9AzCaMb67xo=,ssl=True,abortConnect=False";
