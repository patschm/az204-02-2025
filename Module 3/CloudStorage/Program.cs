...
class Program
{
    private const string connectionString = "DefaultEndpointsProtocol=https;AccountName=psdata;AccountKey=V7tLvJM+1fSBKjhjN0uAcE7zeJTxXaGRlHew1f/UQknDWWgBe8aE1hPPwFzPF0pU2gNms5dREpZ++AStb6MpUg==;EndpointSuffix=core.windows.net";
