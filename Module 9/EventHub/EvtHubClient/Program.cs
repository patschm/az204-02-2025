...
class Program
{
    private static string conStr = "Endpoint=sb://mijnbussen.servicebus.windows.net/;SharedAccessKeyName=schrijverts;SharedAccessKey=grjTeqeb+9qh7UAtQpsjVLUtG6oFMTdvS+AEhD5N0qk=;EntityPath=mijnhup";
